...
const TESTS = [
  ...
  ['deadlift-deficit-2', '2" Deficit Deadlift'],
  ['squat-ssb', 'SSB Squat'],
  ...
  ['deadlift-opposite', 'Opposite Deadlift'],
  ...
  ['squat-blocks', '1" Blocks Squat'],
  ['squat-blocks-4', '4" Blocks Squat'],
  ['deadlift-deficit', '1" Deficit Deadlift'],
