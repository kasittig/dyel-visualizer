    ...
    <CollapsibleSection label="Rep Calculator" persistenceId="visualizer:calculator:rep">
      <div className={styles.card}>
        <header className={styles.masthead}>
          <div>
            <span className={styles.eyebrow}>Training estimate</span>
            <p className={styles.mastheadTitle}>Rep &amp; e1RM calculator</p>
          </div>
          <span className={styles.mastheadNote}>Sheet-derived exercise data</span>
        </header>
