...
| `teamCsvCache.ts`             | Read-through/write-through `localStorage` cache (`dyel:teamCsvCache`) mapping sheet URL to timestamped CSV text. Entries expire after 15 minutes by default, support a refresh bypass, and are capped at the 50 most recently fetched URLs                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
