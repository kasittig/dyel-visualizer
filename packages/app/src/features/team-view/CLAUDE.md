...
| File                      | Purpose                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `TeamViewPage.tsx`        | Page component (typeahead exercise selector + reps input + unit toggle + lifter comparison table); lazy-loaded via `?page=team` query param in `main.tsx` (note: `?page=coach` is supported as a backward-compatible alias); renders per-row exercise/reps override controls in table; renders the facet filter select row; renders the Lift Type chip row; the e1RM column renders the shared `E1RMCell` (`shared/components/E1RMCell.tsx`), passing `actualDisplay`/`projectedDisplay`/`sourceLabel` from the row so a viewer can toggle between the raw and projected-to-today e1RM, matching `RepCalculator`'s toggle                                                              |
