import { pageHref } from '../../shared/pageRouting';
  ...
  return (
    <main className={styles.page}>
      <nav className={styles.guideGrid} aria-label="Learning guides">
        <a className={styles.guideCard} href={pageHref('conjugate')}>
        ...
        <a className={styles.guideCard} href={pageHref('tools', { tool: 'alternatives' })}>
        ...
        <a className={styles.guideCard} href={pageHref('metrics')}>
